...
from routers import project_router, music_router, inpaint_router, lyrics_router, separation_router, download_router, prompt_router, extend_router, album_router, audio_edit_test_router
